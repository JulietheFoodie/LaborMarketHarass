...
reshape(sexdf, idvar = "Var1", timevar = "Var2", direction = "wide")
```
...
reshape(firmtypedf, idvar = "Var1", timevar = "Var2", direction = "wide")
```
...
reshape(firmsizedf, idvar = "Var1", timevar = "Var2", direction = "wide")
```
